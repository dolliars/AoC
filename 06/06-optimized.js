/* so basically this is a venn diagram ...
 * */

const input = `gwlcpbtxmiezd
xwlcpbtzimgdk
tbiwmpcgzdxo
ygzdbpjxncfwimt
...
function findYeses(strings) {
  let splitByGroup = strings.split('\n\n');
  let sum = 0;

  for (let i = 0; i < splitByGroup.length; i++) {
    const yesSet = new Set(splitByGroup[i])
    yesSet.delete('\n'); // i'm reallt not sure how this is being added in the strings split
    sum += yesSet.size;
  }
  console.log(sum);
}
