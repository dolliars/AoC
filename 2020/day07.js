...
function splitString(data){
  ...
  data.forEach(string => {
    string[0] = string[0].replace(removeWord,'');
    ...
    if (secondHalf.includes(myBag)) {
      colorList.push(firstHalf);
    }
  })
  return colorList;
}

function secondScan(data, parsedData) {
  const spliter = 'contain';
  let firstHalf = [];
  let secondHalf = [];
  let removeWord = 'bags ';
  ...
  data.forEach(string => {
    ...
    for (let i = 0; i < parsedData.length; i++) {
      if (secondHalf.includes(parsedData[i])) {
        colorList.push(firstHalf);
      }
    }
  })
...
function thirdScan(data, parsedData) {
  const spliter = 'contain';
  let firstHalf = [];
  let secondHalf = [];
  let removeWord = 'bags ';
...
function fourthScan(data, parsedData) {
  const spliter = 'contain';
  let firstHalf = [];
  let secondHalf = [];
  let removeWord = 'bags ';
...
function fifthScan(data, parsedData) {
  const spliter = 'contain';
  let firstHalf = [];
  let secondHalf = [];
  let removeWord = 'bags ';
...
function sixthScan(data, parsedData) {
  const spliter = 'contain';
  let firstHalf = [];
  let secondHalf = [];
  let removeWord = 'bags ';
...
function seventScan(data, parsedData) {
  const spliter = 'contain';
  let firstHalf = [];
  let secondHalf = [];
  let removeWord = 'bags ';
...
function eigthScan(data, parsedData) {
  const spliter = 'contain';
  let firstHalf = [];
  let secondHalf = [];
  let removeWord = 'bags ';
...
eigthScan(data,(seventScan(data, (sixthScan(data, (fifthScan(data,(fourthScan(data, (thirdScan(data, (secondScan(data, (splitString(data)))))))))))))));
...
// dull purple 
// contain 1 plaid green bag, 5 shiny gold bag
//
// [ 'pale beige ', 'dull purple ' ]
